...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.7.0/deploy/manifest.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.7.0/deploy/ipv6_only.yaml
```
