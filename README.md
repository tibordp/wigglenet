...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.6.1/deploy/manifest.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.6.1/deploy/ipv6_only.yaml
```
