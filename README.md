...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.6.0/deploy/manifest.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/tibordp/wigglenet/v0.6.0/deploy/ipv6_only.yaml
```
